...
from src import CalciumTank


def load_data(session_name):
    ci = CalciumTank("D:/Calcium Image Processing/ProcessedData/" + session_name + "/" + session_name + "_v7.mat")
    print(
        "Successful loaded: " + "D:/Calcium Image Processing/ProcessedData/" + session_name + "/" + session_name + "_v7.mat !")

    with open("D:/Calcium Image Processing/ProcessedData/" + session_name + "/" + session_name + "_peak_indices.pkl",
              'rb') as f:
...
p.segment(x0='x_starts', y0='y_starts', x1='x_ends', y1='y_ends', source=raster_source, color="black", alpha=1, line_width=2)
p.segment(x0='x_starts', y0='y_starts', x1='x_ends', y1='y_ends', source=selected_raster_source, color="red",
                    alpha=1, line_width=2)

# Signal plot
v = figure(width=1000, height=200, x_range=p.x_range, active_scroll='wheel_zoom', tools=['pan', 'wheel_zoom', 'reset'])
